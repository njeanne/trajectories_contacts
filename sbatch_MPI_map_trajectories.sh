...
#SBATCH --output=MPI_traj_map.%j.out

echo "MPI MAP trajectories"
module purge
...
map --profile srun /users/p1237/jeanne/dev/trajectories_contacts/trajectories_contacts_mpi.py \
